...
module.exports = {
  ...
  systemName: 'Dishes Admin',         //系统名称
  copyright: '2022 Croakexiting 出品',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://dianshao-embedded.github.io/dishes-docs/', name: '文档'},
    {link: 'https://github.com/dianshao-embedded/dianshao', icon: 'github'},
  ],
}
